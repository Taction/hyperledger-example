...
function networkUp() {
  ...
  IMAGE_TAG=$IMAGETAG docker-compose -f $COMPOSE_ORDER_FILE up -d 2>&1
...
function networkDown() {
  ...
  # docker-compose -f $COMPOSE_FILE -f $COMPOSE_ORDER_FILE  down --volumes --remove-orphans
  docker-compose -f $COMPOSE_ORDER_FILE  down --volumes --remove-orphans
...
COMPOSE_ORDER_FILE=docker-compose-order.yaml
